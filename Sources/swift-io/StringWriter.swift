...
//    
//    public init(dataEncoding: String.Encoding = DEFAULT_ENCODING) {
...
//            write(string)
//        } else {
//            throw Exception.InvalidDataEncoding(data: dataToWrite, requestedEncoding: encoding, description: description)
//        }
//    }
//    
